...
export function checkForDistance(player: Player | Character, object: Character | GameObject): number {
    const a = player.instance.x - object.instance.x;
    const b = player.instance.y - object.instance.y;
    return Math.sqrt(a * a + b * b);
}

export function isCloseEnough(player: Player | Character, object: Character | GameObject, howFar = FAR_ENOUGH): boolean {
